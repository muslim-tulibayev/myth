...
<div class="mb-6">
    <h1 class="text-2xl font-semibold">New collection</h1>
</div>
...
<form method="POST" action="{{ route('collections.store') }}">
    ...
    <div class="space-y-5">
        ...
        <div class="flex gap-3">
            ...
            <div>
                <label class="block text-sm font-medium mb-1">Color <span class="text-gray-400 font-normal">— random if blank</span></label>
