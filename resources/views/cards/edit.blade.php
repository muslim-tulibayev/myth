...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-semibold mt-1">Edit card</h1>
</div>

<form method="POST" action="{{ route('collections.cards.update', [$collection, $card]) }}">
    @csrf
    @method('PATCH')
    ...
    <div class="space-y-5">
        ...
        <div class="flex gap-3">
            <div class="flex-1">
                ...
                <input type="text" name="word" value="{{ old('word', $card->word) }}" required autofocus
            ...
            <div class="flex-1">
                ...
                <input type="text" name="translation" value="{{ old('translation', $card->translation) }}" required
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400">
        ...
        <div>
            ...
            <textarea name="example" rows="2"
                      class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400">{{ old('example', $card->example) }}</textarea>
        ...
        <div>
            ...
            <textarea name="notes" rows="2"
                      class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400">{{ old('notes', $card->notes) }}</textarea>
